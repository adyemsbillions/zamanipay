...
const Pocket = () => {
  ...
  const fetchPocketData = async () => {
    if (!email) {
      console.log("No email provided to fetchPocketData");
    ...
    try {
      console.log("Fetching pocket data for email:", email);
  ...
  useEffect(() => {
    if (email) {
      console.log("Pocket mounted with params:", { email, full_name, user_id });
      fetchPocketData();
    }
  }, [email]);
  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        {/* Add more pocket-specific features here, e.g., savings goals, etc. */}
      </ScrollView>
      <View style={styles.bottomNav}>
        ...
        >
          ...
          <Text style={[styles.navText, styles.activeNavText]}>Pocket</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.navItem}
